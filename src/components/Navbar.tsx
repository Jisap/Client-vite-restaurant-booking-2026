        ...
        <div className="flex items-center gap-12">
          ...
          <div className="hidden md:flex gap-8 items-center">
            <Link
              to="/"
              className={`
                text-sm transition-colors pb-1 border-b-2 cursor-pointer 
                ${location.pathname === "/"
                  ? (scrolled
            ...
            <Link
              to="/search"
              className={`
                text-sm transition-colors pb-1 border-b-2 border-transparent cursor-pointer 
            ...
            <button
              ...
              className={`
                text-sm transition-colors pb-1 border-b-2 border-transparent cursor-pointer text-left 
